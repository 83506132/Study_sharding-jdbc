...
public interface ProductMapper {
    @Insert("insert into product_info(store_info_id,product_name,spec,region_code,pricem,picture) values(#{store_info_id},#{product_name},#{spec},#{region_code},#{price},#{picture})")
    ...
    @Insert("insert into product_describe(product_info_id,describe,spec,store_info_id) values(#{product_info_id},#{describe},#{store_info_id})")
